...
public class GroupMessageRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    private String destinationRooms;
    private String uid;
    int peopleCount = 0;
    ...
    public GroupMessageRecyclerViewAdapter(RecyclerView recyclerView, String destinationRooms, String uid, Map users){
        this.users = users;
        this.uid = uid;
    ...
    public void sendGcm(String text, String pushToken){
